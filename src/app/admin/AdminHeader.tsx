...
export default function AdminHeader({ title = "Search products, sales..." }) {
  ...
  // Profile state
  const [profile, setProfile] = useState({ name: 'Loading...', role: 'Super Admin', avatar: 'https://ui-avatars.com/api/?name=User&background=random' });
