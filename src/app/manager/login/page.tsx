  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/login', {
        ...
        body: JSON.stringify({ username, password, portal: 'manager' }),
      });
    ...
    <div className="flex h-screen w-full flex-col md:flex-row bg-[#181D2D] text-white overflow-hidden">
      ...
      <div className="hidden md:flex flex-1 flex-col justify-center items-center relative overflow-hidden bg-gradient-to-br from-[#1B2234] to-[#121622] p-12">
        ...
        <div className="relative z-10 flex flex-col items-center animate-fade-in-up">
          ...
          <p className="text-gray-300 text-xl max-w-lg text-center leading-relaxed">Secure access portal for staff and managers. Monitor sales, track inventory, and grow your operations.</p>
        </div>
      </div>
          ...
          {!isForgotPassword ? (
            <>
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Sign in to Manager Portal</p>
              </div>
